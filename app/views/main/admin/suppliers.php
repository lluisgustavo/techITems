								...
								<div class="modal-body">
									...
									<div class="row mb-1">
										...
										<div class="form-group col-md-8"> 
											<input name="fornecedor-endereco-ref" id="fornecedor-endereco-ref" placeholder="Referência" type="text" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="modal-body">
									...
									<div class="row mb-1">
										<div class="form-group col-md-4">
											...
											<input onblur="pesquisacep(this.value);" name="editar-fornecedor-endereco-CEP" id="editar-fornecedor-endereco-CEP" type="text" class="form-control" placeholder="CEP" required>
										</div>
										<div class="form-group col-md-8">
									...
									<div class="form-group col-md-8">
										...
										<input name="editar-fornecedor-endereco-ref" id="editar-fornecedor-endereco-ref" type="text" class="form-control" placeholder="Referência" required>
									</div>
									</div>
								</div>  
								<div class="modal-footer">
